    ...
    return (
        <div className="h-full w-full overflow-hidden flex flex-col relative justify-center items-center">
            ...
            <div className="about-header rounded-xl my-2">
                <p className="uppercase text-4xl my-2 mx-16 text-white">about this demo</p>
            </div>
            ...
            <div className="flex flex-col justify-center z-10 rounded-xl w-9/12 my-1 px-6">
                ...
                <div className="mt-2 flex flex-row justify-center flex-wrap">
                    {teamInfo.map((member, index) => (
                        ...
                        >
                            <div className="flex justify-center items-center w-14 h-14 rounded-full bg-[#51F83B] mr-4">
